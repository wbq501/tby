...
public class LogisticsWebActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_web_logistics);
        initToolBar();
        ...
        setTitle(title);
        initView();
        ((RelativeLayout.LayoutParams)mWebView.getLayoutParams()).topMargin = ViewUtils.dip2px(96) * -1 + (int) getResources().getDimension(R.dimen.toolbar_height);
