...
public class ArcMenu extends RelativeLayout {
    ...
    private OnArcMenuExpandListener mOnArcMenuExpandListener;
    ...
    public void setOnArcMenuExpandListener(OnArcMenuExpandListener listener) {
        mOnArcMenuExpandListener = listener;
        if (mArcLayout != null) {
            mArcLayout.setOnArcMenuExpandListener(listener);
        }
    }
    ...
    public void setExpand(boolean b) {
        mArcLayout.switchState(b, false);
        mHintView.startAnimation(createHintSwitchAnimation(mArcLayout.isExpanded()));
    }
    ...
    public interface OnArcMenuExpandListener {
        void onExpand(boolean b);
    }
}
