...
import com.baigu.dms.common.view.circleimage.transfer.style.IProgressIndicator;
import com.baigu.dms.common.view.circleimage.transfer.view.image.TransferImage;

import java.util.List;

/**
 * 高清图尚未加载，使用原 ImageView 中显示的图片作为缩略图。
 * 同时使用 {@link Transfer Image#CATE_ANIMA_APART} 动画类型展示图片
 * <p>
