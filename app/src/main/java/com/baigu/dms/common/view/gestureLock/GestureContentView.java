...
public class GestureContentView extends ViewGroup {
     ...
     * 声明一个集合用来封装坐标集合
     */
    private List<GesturePointEntity> list;
    private Context context;
    private boolean isVerify;
    GestureDrawline gestureDrawline;
     ...
     */
    public GestureContentView(Context context, boolean isVerify, String passWord, GestureDrawline
            .GestureCallBack callBack) {
        super(context);
        screenDispaly = ViewUtils.getScreenSize(context);
        //blockWidth = screenDispaly[0]/3;
       // blockWidth = (int) (screenDispaly[0] / 4.3f + 0.5f);
        blockWidth = (int) (screenDispaly[0] / 4);
        this.list = new ArrayList<GesturePointEntity>();
    ...
    private void addChild() {
        for (int i = 0; i < 9; i++) {
            ...
            image.setBackgroundResource(R.mipmap.im_gesture_node_normal);
            this.addView(image);
            invalidate();
            // 第几行
            int row = i / 3;
            ...
            GesturePointEntity p = new GesturePointEntity(leftX, rightX, topY, bottomY, image, i
                    + 1);
            this.list.add(p);
        }
    }
    ...
    public void setParentView(ViewGroup parent) {
       // int width = (int) (screenDispaly[0] * 0.69f + .5f);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        for (int i = 0; i < getChildCount(); i++) {
            ...
            int col = i % 3;
            View v = getChildAt(i);
            v.layout(col * blockWidth + blockWidth / baseNum, row * blockWidth + blockWidth /
                    baseNum,
