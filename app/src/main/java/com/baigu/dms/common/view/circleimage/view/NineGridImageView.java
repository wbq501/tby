...
public class NineGridImageView<T> extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mImgDataList.size() == 1) { //单张图片直接使用glide加载后计算图片高度 add by mickyliu
    ...
    private void layoutForNoSpanChildrenView(int childrenCount) {
        ...
        for (int i = 0; i < childrenCount; i++) {
            ...
            if (childrenCount == 1) {
                ...
                gridInfo.singleImage = true;
                gridInfo.singleImageWidth = mSingleImgSize;
                gridInfo.nowHeight = mHeight;
            }
            if (mAdapter != null) {
                mAdapter.onDisplayImage(getContext(), this, childrenView, mImgDataList.get(i), gridInfo);
            }
        }
    }
    ...
    private void layoutForThreeChildrenView(int childrenCount) {
        ...
        for (int i = 0; i < childrenCount; i++) {
            ...
            if (mAdapter != null) {
                mAdapter.onDisplayImage(getContext(), this, childrenView, mImgDataList.get(i), null);
            }
        }
    }
            ...
            if (mAdapter != null) {
                ...
                imageView.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        mAdapter.onItemImageClick(getContext(), NineGridImageView.this,  (ImageView) v, position, mImgDataList);
