package com.baigu.dms.common.view.clipviewpager;
...
public class ClipViewPager extends ViewPager {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        if (ev.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            if (view != null) {
                int index = ((ClipViewHolder) view.getTag()).position;
    ...
    private View viewOfClickOnScreen(MotionEvent ev) {
        ...
        for (int i = 0; i < childCount; i++) {
            View v = getChildAt(i);
            int position = ((ClipViewHolder) v.getTag()).position;
    ...
    public static class ClipViewHolder {
        public int position;
    }
}
