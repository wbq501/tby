...
package com.baigu.dms.common.view.arcmenu;
...
public class ArcLayout extends ViewGroup {
    ...
    private int mChildPadding = 1;

    private int mLayoutPadding = 4;
    ...
    private ArcMenu.OnArcMenuExpandListener mOnArcMenuExpandListener;
    ...
    public ArcLayout(Context context, AttributeSet attrs) {
        ...
        mMinRadius = ViewUtils.dip2px(mMinRadius);
        mChildPadding = ViewUtils.dip2px(mChildPadding);
        mLayoutPadding = ViewUtils.dip2px(mLayoutPadding);
    }
...
//                mChildPadding, mMinRadius);
        final int radius = mRadius = mMinRadius;
    ...
    public void switchState(final boolean showAnimation) {
        ...
        if (mOnArcMenuExpandListener != null) {
            mOnArcMenuExpandListener.onExpand(mExpanded);
        }
    }
     ...
     * @param showAnimation
     */
    public void switchState(final boolean expand, final boolean showAnimation) {
        if (showAnimation) {
            final int childCount = getChildCount();
            for (int i = 0; i < childCount; i++) {
                bindChildAnimation(getChildAt(i), i, 300);
    ...
    public void setOnArcMenuExpandListener(ArcMenu.OnArcMenuExpandListener listener) {
        mOnArcMenuExpandListener = listener;
    }
