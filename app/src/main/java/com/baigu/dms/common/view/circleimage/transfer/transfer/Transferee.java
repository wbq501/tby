package com.baigu.dms.common.view.circleimage.transfer.transfer;
...
import com.baigu.dms.common.view.circleimage.transfer.loader.ImageLoader;
import com.baigu.dms.common.view.circleimage.transfer.loader.NoneImageLoader;
import com.baigu.dms.common.view.circleimage.transfer.style.index.CircleIndexIndicator;
import com.baigu.dms.common.view.circleimage.transfer.style.progress.ProgressBarIndicator;
...
public class Transferee implements DialogInterface.OnShowListener,
    ...
    private void createDialog() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            transDialog.getWindow().addFlags(WindowManager.LayoutParams.FLAG_FORCE_NOT_FULLSCREEN);
        }
