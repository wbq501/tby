...
public class GesturePointEntity {
	/**
	 * 左边x的值
	 */
	private int leftX;
	...
	public GesturePointEntity(int leftX, int rightX, int topY, int bottomY,
	...
	public void setPointState(int state) {
		...
		switch (state) {
			case Constants.POINT_STATE_NORMAL:
				this.image.setBackgroundResource(R.mipmap.im_gesture_node_normal);
				break;
			case Constants.POINT_STATE_SELECTED:
				this.image.setBackgroundResource(R.mipmap.im_gesture_node_pressed);
				break;
			case Constants.POINT_STATE_WRONG:
				this.image.setBackgroundResource(R.mipmap.im_gesture_node_wrong);
				break;
			default:
				break;
		}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		GesturePointEntity other = (GesturePointEntity) obj;
