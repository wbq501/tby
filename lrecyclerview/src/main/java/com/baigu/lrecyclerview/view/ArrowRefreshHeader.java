package com.baigu.lrecyclerview.view;
...
import com.baigu.lrecyclerview.progressindicator.AVLoadingIndicatorView;
...
public class ArrowRefreshHeader extends LinearLayout implements IRefreshHeader {
    ...
    public void setLScrollListener(LRecyclerView.LScrollListener listener) {
    ...
    public void onMove(float offSet, float sumOffSet) {
        ...
        if (getVisibleHeight() > 0 || offSet > 0) {
            if (mLScrollListener != null) {
                mLScrollListener.onHeaderShowed((int) offSet + getVisibleHeight());
            }
    ...
    private void smoothScrollTo(final int destHeight) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation)
            {
                ...
                if (mLScrollListener != null) {
                    mLScrollListener.onHeaderShowed(destHeight);
                }
            }
        });
        animator.start();
